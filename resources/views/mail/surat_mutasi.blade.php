...
<body>
    ...
    <table class="table-type-1 mx-20 w-100 mb-40">
        <tr>
            <td width="20%">Nama</td>
            <td width="2%">:</td>
            <td>&nbsp; <b>Kania Luthfiya Faisal</b></td>
        </tr>
        <tr>
            <td width="20%">Tempat, Tgl Lahir</td>
            <td>:</td>
            <td>&nbsp; Jakarta, 28/06/2015</td>
        </tr>
        <tr>
            <td width="20%">NISN</td>
            <td>:</td>
        ...
        <tr>
            <td width="20%">Ayah</td>
            <td>:</td>
            <td>&nbsp; Khairil Fahmi Faisal</td>
        </tr>
        <tr>
            <td width="20%">Ibu</td>
            <td>:</td>
            <td>&nbsp; Lisa Nisfi Afifah</td>
        </tr>
        <tr>
            <td width="20%">Pekerjaan Orang Tua</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td style="padding-right: 120px;">&nbsp; Jl. Kebon Jahe VII No. 53, RT 14, RW 02, Kel. Petojo Selatan, Kec. Gambir, Jakarta Pusat, DKI Jakarta</td>
        </tr>
        <tr>
            <td width="20%">Tanggal Pindah</td>
            <td>:</td>
            <td>&nbsp; 2024-10-21</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; Pindah ke sekolah dekat domisili</td>
