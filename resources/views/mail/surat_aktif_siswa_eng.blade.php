...
<body>
    ...
    <p class="text-center mt-0">
        PBx/SKt/2024/VIII/1801011
    </p>

    <p class="ml-20 mt-40">The undersigned is principal of PKBM Piwulang Becik</p>
    <table class="table-type-1 mx-20 w-100 mb-40">
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; Jl Kaplingrejo I No 7 Rt 9 Rw 3 Gendongan Salatiga, Central Java</td>

        </tr>
    </table>
    <p class="ml-20 mt-40">Explain that</p>
    <table class="table-type-1 mx-20 w-100 mb-40">
        <tr>
            <td width="20%">Name</td>
            <td width="2%">:</td>
            <td>&nbsp; Xavon Yobel Zaneta Jahja</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; 2407225/3152177894</td>
        </tr>
        <tr>
            <td width="20%">Place & Date of Birth</td>

            <td>:</td>
            <td>&nbsp; Jakarta, 20/02/2015</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; Jl. Jeruk Utama 3 Taman Kebon Jeruk Blok G1/93, Kel. Srengseng, <br> Kec. Kembangan,

                Jakarta Barat, DKI Jakarta, Indonesia</td>

        </tr>
       
    </table>
    <p class="ml-20 mt-40">Is registered as a student of grade 4 of PKBM Piwulang Becik for the academic year of 2024/2025.</p> 
    <p class="ml-20 ">It would be highly appreciated if you could grant him the necessary visa to enter your country.

</p>
    <p class="ml-20 ">Thus this certificate is made in truth. Thank you in advance for your kind assistance and cooperation.
        ...
        <table width="100%">
            <tbody>
                <tr>
                    ...
                    <td class="text-left p-relative" width="200">
                        <div>
                            Salatiga, August 15th, 2024<br />
