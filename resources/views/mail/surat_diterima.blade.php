...
<body>
    ...
    <h3 class="text-center mb-0">
        SURAT KETERANGAN DITERIMA <br>
        MENJADI SISWA PKBM PIWULANG BECIK
    </h3>
    <p class="text-center mt-0">
        PBx/SKt/2024/VI/2404003
    </p>

    <p class="ml-20 mt-40">Yang bertanda tangan dibawah ini Kepala PKBM Piwulang Becik</p>
    ...
    <table class="table-type-1 mx-20 w-100 mb-40">
        <tr>
            <td width="20%">Nama</td>
            <td width="2%">:</td>
            <td>&nbsp; Kautsar Lathifah</td>
        </tr>
        <tr>
            <td width="20%">NIK</td>
            <td>:</td>
            <td>&nbsp; 3205146104140006</td>
        </tr>
        <tr>
            <td width="20%">Tempat, Tgl Lahir</td>
            <td>:</td>
            <td>&nbsp; Qom, 01 April 2014</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; Husna Thahiroh</td>
        </tr>
        <tr>
            <td width="20%">Diterima Kelas</td>
            <td>:</td>
            <td>&nbsp; Kelas 05, Tahun Ajaran 2024/2025</td>
        ...
        <tr>
            ...
            <td>:</td>
            <td>&nbsp; <span class="w-span">Jl. Arga Nirwana 7 Cluster Arga Nirwana 1 No. 21, RT.06/RW.12, Kel. <br> Mulyaharja , Kec. Bogor Selatan, Kota Bogor, Provinsi Jawa Barat</span></td>
        </tr>
    </table>
    <p class="ml-20 mt-40">Demikian harap surat ini digunakan sesuai dengan keperluan administrasi sekolah.</p>
